...
// import { getUser, logout, register } from '../../../state/Auth/Action.js';
...
//                    <Avatar  onClick={handleLogout} sx={{bgcolor:deepPurple[600]}}>{auth.user.firstName[0].toUpperCase()}</Avatar>
//                  ) : (
...
//                   sx={{bgcolor:deepPurple[600]}}>{auth.user.firstName[0].toUpperCase()}</Avatar>
//                  ) : (
//                   <Button onClick={handleOpen} >
//                     Sing In
//                   </Button>
            ...
            >
              <DialogPanel className="relative flex flex-col w-full max-w-xs pb-12 overflow-y-auto bg-white shadow-xl">
                ...
                <div className="px-4 py-6 space-y-6 border-t border-gray-200">
                  <div className="flow-root">
                    {auth.user?.firstName ? (
                      <Avatar onClick={handleLogout} sx={{ bgcolor: deepPurple[600] }}>
