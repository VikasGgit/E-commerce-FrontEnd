...
//                                       'relative z-10 flex items-center justify-center text-sm font-medium transition-colors duration-200 ease-out border-b-2 -mb-px pt-px'
//                                     )}
//                                   >
//                                     {category.name}
//                                   </Popover.Button>
...
//                     <button
//                       type="button"
//                       className="p-2 text-gray-400 bg-white rounded-md"
//                       onClick={() => setOpen(true)}
//                     >
//                       <span className="sr-only">Open menu</span>
//                       <Bars3Icon className="w-6 h-6" aria-hidden="true" />
...
//                   <div className="flex items-center justify-end flex-1 lg:flex lg:items-center lg:justify-end lg:flex-1">
